// Wait for the document to load (apparently document.onload has essentially been replaced with this)
window.onload = function () {
  var photoListing = [];
  // Array of objects will consist of photoId, photoInfo, photoSizes
  var currentPhoto;
